...
export const EASTER_EGGS = {
  ...
  'jonas': { text: "Le créateur du jeu 😛👑", anim: 'spiralJonas' },
  'suhard': { text: "Le boss est dans la place 😎", anim: 'bounce' },
  // === COLLÈGUES EDUSERVICES ===
  'thomas': { text: "Thomas est dans la place ! 🦖⚔️", anim: 'adventureThomas' },
  'lucie': { text: "Lucie la boss 💃✨", anim: 'danceLucie' },
  'megane': { text: "Meigan part en voyage 👩‍⚕️✈️", anim: 'nurseTraveler' },
  'mégane': { text: "Meigan part en voyage 👩‍⚕️✈️", anim: 'nurseTraveler' },
  'meigan': { text: "Meigan part en voyage 👩‍⚕️✈️", anim: 'nurseTraveler' },
  'jade': { text: "Jade 💻 cyber queen du bureau", anim: 'cyberJade' },
  'keina': { text: "Keina dans la place ! 🌟", anim: 'bounce' },
  'noemie': { text: "Noémie la K-pop queen 🎤💜", anim: 'kpopNoemie' },
  'noémie': { text: "Noémie la K-pop queen 🎤💜", anim: 'kpopNoemie' },
  'geoffrey': { text: "Geoffrey GG WP dans la vie 💍⚔️", anim: 'kcorpWedding' },
  'joffrey': { text: "Geoffrey GG WP dans la vie 💍⚔️", anim: 'kcorpWedding' },
  'zarina': { text: "Zarina 💖", anim: 'heartsZarina' },
  ...
  'yassine': { text: "YASSINE EST LÀ. TOUT LE MONDE L'A ENTENDU. 📢🔍", anim: 'seoLoud' },
  ...
  'sarah': { text: "Sarah princesse globe-trotteuse 🏰✈️", anim: 'disneyTravel' },
  ...
  // === MARKETING & STRATÉGIE ===
  'marketing': { text: "Ah le beau buzzword 📊🚀", anim: 'marketingRocket' },
  'stratégie': { text: "Stratégie de ouf 🎯", anim: 'marketingRocket' },
  'strategie': { text: "Stratégie de ouf 🎯", anim: 'marketingRocket' },
  'branding': { text: "L'image c'est tout 🎨👑", anim: 'marketingRocket' },
  'marque': { text: "Brand awareness +100% 📈", anim: 'marketingRocket' },
  'publicité': { text: "Pub ou placement produit ? 📺", anim: 'marketingRocket' },
  'publicite': { text: "Pub ou placement produit ? 📺", anim: 'marketingRocket' },
  'pub': { text: "Ou une bière ? 🍺📺", anim: 'pop' },
  'influenceur': { text: "Promo code EDUSEMANTIX 📱", anim: 'bounce' },
  'influenceuse': { text: "Swipe up les amis 📱✨", anim: 'bounce' },
  'contenu': { text: "Content is king 👑", anim: 'marketingRocket' },
  'audience': { text: "Target audience: toi 🎯", anim: 'marketingRocket' },
  'cible': { text: "Persona identifié ! 🎯", anim: 'marketingRocket' },
  'conversion': { text: "Taux de conversion: 100% addict 📈", anim: 'marketingRocket' },
  'funnel': { text: "Top of funnel vibes 🔽", anim: 'marketingRocket' },
  'prospect': { text: "Nouveau lead détecté 📋", anim: 'marketingRocket' },
  'lead': { text: "Lead qualifié ✅📞", anim: 'marketingRocket' },
  'client': { text: "Le client est roi 👑", anim: 'moneyRain' },
  'vente': { text: "CLOSING TIME 🤝💰", anim: 'moneyRain' },
  'vendre': { text: "Vends-moi ce stylo 🖊️", anim: 'moneyRain' },
  'commercial': { text: "Objectif atteint ? 📊🎯", anim: 'moneyRain' },
  'objectif': { text: "OKR validé ✅🏆", anim: 'marketingRocket' },
  'kpi': { text: "Tous les voyants sont au vert 🟢📊", anim: 'marketingRocket' },
  'roi': { text: "Return On Investment... ou juste un roi ? 👑📈", anim: 'moneyRain' },
  'croissance': { text: "TO THE MOON 🚀📈", anim: 'marketingRocket' },
  'chiffre': { text: "Les chiffres parlent 📊", anim: 'marketingRocket' },
  'résultat': { text: "Les résultats sont là 📈✅", anim: 'marketingRocket' },
  'resultat': { text: "Les résultats sont là 📈✅", anim: 'marketingRocket' },
  'performance': { text: "High performer detected 🔥", anim: 'marketingRocket' },
  'benchmark': { text: "On benchmark tout ici 📊", anim: 'marketingRocket' },
  'innovation': { text: "Disruptif 🚀💡", anim: 'marketingRocket' },
  'digital': { text: "Transformation digitale en cours 💻✨", anim: 'glitch' },
  'numérique': { text: "01101101 🤖", anim: 'glitch' },
  'numerique': { text: "01101101 🤖", anim: 'glitch' },
  'startup': { text: "Pivot ! Pivot ! PIVOT ! 🔄🚀", anim: 'marketingRocket' },
  'entrepreneur': { text: "Rise and grind 💪☀️", anim: 'marketingRocket' },
  'business': { text: "It's not personal, it's business 💼", anim: 'moneyRain' },
  'entreprise': { text: "Corporate vibes 🏢", anim: 'pop' },
  'réseau': { text: "Networking is key 🤝🌐", anim: 'marketingRocket' },
  'reseau': { text: "Networking is key 🤝🌐", anim: 'marketingRocket' },
  'communication': { text: "On communique ! 📡📢", anim: 'marketingRocket' },
  'campagne': { text: "Campagne lancée ! 🚀📣", anim: 'marketingRocket' },
  'budget': { text: "Le budget a disparu 💸👻", anim: 'moneyRain' },
  'investir': { text: "Smart money move 🧠💰", anim: 'moneyRain' },
  'investissement': { text: "ROI dans 3... 2... 1... 📈", anim: 'moneyRain' },
  'tendance': { text: "Ça trend là 📈🔥", anim: 'marketingRocket' },
  'viral': { text: "C'est devenu viral 🦠🔥", anim: 'firework' },
  'buzz': { text: "BUZZZZZ 🐝📱", anim: 'bounce' },
  'engagement': { text: "Like, share, comment 💬❤️", anim: 'heartbeat' },
  'communauté': { text: "Community manager spotted 👀", anim: 'pop' },
  'communaute': { text: "Community manager spotted 👀", anim: 'pop' },
  'newsletter': { text: "Personne ne la lit 📧😅", anim: 'wiggle' },
  'emailing': { text: "Taux d'ouverture: 2% 📧💀", anim: 'wiggle' },
  'seo': { text: "Yassine est fier de toi 🔍📈", anim: 'seoLoud' },
  'référencement': { text: "Page 1 de Google ou rien 🥇", anim: 'seoLoud' },
  'referencement': { text: "Page 1 de Google ou rien 🥇", anim: 'seoLoud' },
  'blog': { text: "Article de 2000 mots minimum 📝", anim: 'pop' },
  'site': { text: "Responsive ou rien 📱💻", anim: 'glitch' },
  'web': { text: "World Wide Web 🌐🕸️", anim: 'glitch' },
  'design': { text: "C'est beau mais le brief disait pas ça 🎨😬", anim: 'pop' },
  'logo': { text: "Plus gros le logo ! 🔍", anim: 'bounce' },
  'créatif': { text: "Pense outside the box 📦💡", anim: 'rainbow' },
  'creatif': { text: "Pense outside the box 📦💡", anim: 'rainbow' },
  'deadline': { text: "C'était pour hier 💀⏰", anim: 'siren' },
  'délai': { text: "On est dans les temps... non ? ⏳", anim: 'wiggle' },
  'delai': { text: "On est dans les temps... non ? ⏳", anim: 'wiggle' },
  'urgent': { text: "TOUT est urgent ici 🚨", anim: 'siren' },
  'brief': { text: "Le brief a changé 3 fois 📄🔄", anim: 'wiggle' },
  'brainstorm': { text: "Post-it partout 🟡🟢🟣", anim: 'bounce' },
  'formation': { text: "On se forme à EduSemantix 📚🎓", anim: 'pop' },
  'diplôme': { text: "Bac +5 en mots 🎓", anim: 'bounce' },
  'diplome': { text: "Bac +5 en mots 🎓", anim: 'bounce' },
  'étudiant': { text: "La vie étudiante 📚🍜", anim: 'pop' },
  'etudiant': { text: "La vie étudiante 📚🍜", anim: 'pop' },
  'école': { text: "L'école de la vie 🏫", anim: 'pop' },
  'ecole': { text: "L'école de la vie 🏫", anim: 'pop' },
  'professeur': { text: "Prof mode activé 🧑‍🏫", anim: 'pop' },
  'examen': { text: "Stress level: 9000 📝😰", anim: 'siren' },
  'révision': { text: "Révise sur EduSemantix plutôt 📖", anim: 'wiggle' },
  'revision': { text: "Révise sur EduSemantix plutôt 📖", anim: 'wiggle' },
  // === ARGENT & BUSINESS ===
  'million': { text: "Bientôt millionnaire 💰🤑", anim: 'moneyRain' },
  'milliard': { text: "Jeff Bezos qui ? 💸", anim: 'moneyRain' },
  'fortune': { text: "La roue tourne 🎡💰", anim: 'moneyRain' },
  'luxe': { text: "Champagne et caviar 🥂💎", anim: 'moneyRain' },
  'prix': { text: "C'est combien ? 💸", anim: 'moneyRain' },
  'gratuit': { text: "Le meilleur prix 🆓✨", anim: 'bounce' },
  'soldes': { text: "-50% SUR TOUT 🏷️🛍️", anim: 'moneyRain' },
  'achat': { text: "Ajouter au panier 🛒", anim: 'pop' },
  'shopping': { text: "Carte bleue en PLS 💳😵", anim: 'moneyRain' },
  'promotion': { text: "OFFRE LIMITÉE ⏰🔥", anim: 'firework' },
  'réduction': { text: "Code promo: SEMANTIX 🏷️", anim: 'moneyRain' },
  'reduction': { text: "Code promo: SEMANTIX 🏷️", anim: 'moneyRain' },
  // === VIE QUOTIDIENNE ===
  'maison': { text: "Home sweet home 🏠", anim: 'float' },
  'appartement': { text: "T2 à Paris = 1500€ 🥲", anim: 'moneyRain' },
  'loyer': { text: "Le 1er du mois 💸😭", anim: 'moneyRain' },
  'cuisine': { text: "Top Chef à la maison 👨‍🍳", anim: 'float' },
  'recette': { text: "Secret recipe 🤫🍳", anim: 'float' },
  'restaurant': { text: "L'addition svp 💸🍽️", anim: 'moneyRain' },
  'dessert': { text: "Toujours de la place pour le dessert 🍰", anim: 'float' },
  'gâteau': { text: "La cerise sur le gâteau 🎂", anim: 'bounce' },
  'gateau': { text: "La cerise sur le gâteau 🎂", anim: 'bounce' },
  'chocolat': { text: "La drogue douce 🍫😍", anim: 'float' },
  'bonbon': { text: "Trick or treat 🍬", anim: 'pop' },
  'thé': { text: "Spill the tea ☕🫖", anim: 'float' },
  'the': { text: "Spill the tea ☕🫖", anim: 'float' },
  'boire': { text: "Tchin tchin 🥂", anim: 'float' },
  'fête': { text: "PARTY TIME 🎉🪩", anim: 'disco' },
  'fete': { text: "PARTY TIME 🎉🪩", anim: 'disco' },
  'soirée': { text: "Soirée EduSemantix quand ? 🎉", anim: 'disco' },
  'soiree': { text: "Soirée EduSemantix quand ? 🎉", anim: 'disco' },
  'karaoké': { text: "🎤 DONT STOP BELIEVIIIIN", anim: 'disco' },
  'karaoke': { text: "🎤 DONT STOP BELIEVIIIIN", anim: 'disco' },
  'danseur': { text: "Danse comme si personne regardait 💃", anim: 'disco' },
  'danseuse': { text: "Danse comme si personne regardait 💃", anim: 'disco' },
  'chance': { text: "La chance sourit aux joueurs 🍀", anim: 'casino' },
  'hasard': { text: "Le hasard fait bien les choses 🎲", anim: 'casino' },
  'loterie': { text: "Et si c'était toi ? 🎰", anim: 'casino' },
  'casino': { text: "All in ! 🎰♠️", anim: 'casino' },
  'poker': { text: "Poker face 🃏😐", anim: 'casino' },
  'voyage': { text: "Prochaine destination ? ✈️🌍", anim: 'plane' },
  'voyager': { text: "L'aventure t'appelle 🧳✈️", anim: 'plane' },
  'plage': { text: "Sable chaud et cocotiers 🏖️", anim: 'ocean' },
  'mer': { text: "La mer est belle 🌊", anim: 'ocean' },
  'océan': { text: "Deep blue 🌊🐋", anim: 'ocean' },
  'ocean': { text: "Deep blue 🌊🐋", anim: 'ocean' },
  'montagne': { text: "The hills are alive 🏔️🎵", anim: 'rocket' },
  'nature': { text: "Retour aux sources 🌿", anim: 'butterfly' },
  'jardin': { text: "Touche de l'herbe 🌱", anim: 'butterfly' },
  'fleur': { text: "C'est le printemps 🌸🌺", anim: 'butterfly' },
  'papillon': { text: "Effet papillon 🦋", anim: 'butterfly' },
  'animal': { text: "Quel est ton animal totem ? 🐾", anim: 'bounce' },
  'licorne': { text: "Les licornes existent ! 🦄✨", anim: 'rainbow' },
  'dragon': { text: "Dracarys 🐉🔥", anim: 'explosion' },
  'ninja': { text: "Tu ne m'as pas vu 🥷💨", anim: 'ninja' },
  'pirate': { text: "Yarr ! 🏴‍☠️🦜", anim: 'ocean' },
  'trésor': { text: "X marks the spot 🗺️💎", anim: 'shake-gold' },
  'tresor': { text: "X marks the spot 🗺️💎", anim: 'shake-gold' },
  'magique': { text: "Abracadabra ✨🪄", anim: 'portal' },
  'magie': { text: "Expecto Patronum 🪄⚡", anim: 'portal' },
  'sorcier': { text: "T'es un sorcier Harry 🧙‍♂️", anim: 'portal' },
  'étoile': { text: "Brille comme une étoile ⭐✨", anim: 'rocket' },
  'etoile': { text: "Brille comme une étoile ⭐✨", anim: 'rocket' },
  'lune': { text: "Fly me to the moon 🌙", anim: 'rocket' },
  'planète': { text: "Il n'y a pas de planète B 🌍", anim: 'rocket' },
  'planete': { text: "Il n'y a pas de planète B 🌍", anim: 'rocket' },
  'galaxie': { text: "Far far away 🌌", anim: 'rocket' },
  'univers': { text: "42 🌌🤔", anim: 'blackhole' },
  'infini': { text: "To infinity and beyond ! 🚀♾️", anim: 'rocket' },
  'explosion': { text: "BOOM 💥🔥", anim: 'explosion' },
  'tonnerre': { text: "THOR MODE ⚡🔨", anim: 'lightning' },
  'éclair': { text: "Flash ⚡💨", anim: 'lightning' },
  'eclair': { text: "Flash ⚡💨", anim: 'lightning' },
  'tempête': { text: "La tempête arrive 🌪️", anim: 'tornado' },
  'tempete': { text: "La tempête arrive 🌪️", anim: 'tornado' },
  'ouragan': { text: "Category 5 🌀💨", anim: 'tornado' },
  'tsunami': { text: "VAGUE GÉANTE 🌊🌊🌊", anim: 'tsunami' },
  'volcan': { text: "Ça va péter 🌋🔥", anim: 'volcano' },
  'tremblement': { text: "Tremblement de terre 🫨", anim: 'explosion' },
  'héros': { text: "Not the hero we deserve 🦸", anim: 'shield' },
  'heros': { text: "Not the hero we deserve 🦸", anim: 'shield' },
  'superpouvoirs': { text: "With great power... 🕷️", anim: 'shield' },
  'batman': { text: "I'm Batman 🦇", anim: 'bat' },
  'superman': { text: "It's a bird, it's a plane 🦸‍♂️", anim: 'shield' },
  'spiderman': { text: "With great power... 🕷️🕸️", anim: 'shield' },
  'matrix': { text: "Red pill or blue pill 💊", anim: 'matrix' },
  'simulation': { text: "On vit dans une simulation 🤖", anim: 'matrix' },
  'cinéma': { text: "Popcorn ready 🍿🎬", anim: 'pop' },
  'cinema': { text: "Popcorn ready 🍿🎬", anim: 'pop' },
  'film': { text: "Ça mériterait un film 🎬", anim: 'pop' },
  'série': { text: "Encore un épisode... 📺", anim: 'pop' },
  'serie': { text: "Encore un épisode... 📺", anim: 'pop' },
  'livre': { text: "Un bon livre > Netflix 📖", anim: 'float' },
  'lire': { text: "Bookworm 📚🐛", anim: 'float' },
  'écrire': { text: "Il était une fois... 📝✨", anim: 'float' },
  'ecrire': { text: "Il était une fois... 📝✨", anim: 'float' },
  'photo': { text: "📸 Say cheese !", anim: 'pop' },
  'photographe': { text: "C'est dans la boîte 📷✨", anim: 'pop' },
  'peinture': { text: "Bob Ross vibes 🎨🌲", anim: 'rainbow' },
  'art': { text: "L'art est une explosion 💥🎨", anim: 'explosion' },
  'sculpture': { text: "David de Michel-Ange 🗿", anim: 'float' },
